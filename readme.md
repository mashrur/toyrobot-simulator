...
This is a command line Java application that simulates a walking robot
on a surface
...
- Implemented and tested using JDK 8

- Tests require JUnit 5 and JMockit

- Project dependencies and compiling managed by Maven

- In terms of IDE, I used Eclipse Oxygen which has support of JUnit 5.
